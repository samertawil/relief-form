...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('damage_masters', function (Blueprint $table) {
            $table->id();
            $table->foreignId('profile_id')->constrained('citzen_profiles');  // create profile_id to be as "owner for damage file"  صاحب ملف الاضرار - الذي وقع عليه الضرر  بحال الاضرار الاقتصادية او جزء من الاضرار البشرية
